...
export default function Timer({ timeLeftMs, progress }) {
  return (
    <div className="absolute top-4 left-1/2 -translate-x-1/2 text-center pointer-events-none">
      <div className="font-display font-black text-[46px] leading-none text-white text-glow">
        {formatTime(timeLeftMs)}
      </div>
      <div className="text-[11px] tracking-[0.22em] uppercase text-magic/80 mt-0.5">
        time left
      </div>
      <div className="w-[220px] h-1.5 mx-auto mt-2 rounded bg-white/15 overflow-hidden">
        <i
