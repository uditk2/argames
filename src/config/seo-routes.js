...
export const ROUTES = [
  ...
  },
  {
    ...
    game: 'temple',
    title: 'Relic Hunter: Temple Collapse — Free 3D Temple Maze Runner | SlayFit',
    description:
      'Relic Hunter: Temple Collapse is a free, no-download 3D maze runner. Steal the Syamantaka Gem and escape the collapsing temple — read the maze, take the right turns, jump the beams, fire jets and floor gaps, and duck the swinging blades. Play instantly in your browser, no install.',
    body: `<main>
        <h1>Relic Hunter: Temple Collapse — 3D Temple Maze Runner You Can Play Today</h1>
        <p>Relic Hunter: Temple Collapse is a free, no-download <strong>3D maze runner</strong> you can play right now in your browser. You play Mira or Vikram, a relic hunter who lifts the Syamantaka Gem — Surya's sun-gem — and brings the whole photoreal temple down. Sprint out as it collapses: read the maze on the map, turn the right way at every junction, jump the fallen stone beams, fire jets and floor gaps, and duck the swinging blades. Beat the collapse timer to reach the light. Wrong turns are dead ends and a blade or fire is instant death, so every corner counts.</p>
        <h2>Play the 3D temple maze runner today — no download</h2>
        <p>There is nothing to install. Open the page and run — Relic Hunter is one of SlayFit's free no-download games: instant, fast and easy to share. It is a six-trial campaign with three shared lives, each trial a tougher maze than the last, ending with the Syamantaka Gem grab and a dash into daylight.</p>
        <h2>How to play</h2>
