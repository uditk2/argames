...
//
// Palette + brand are mirrored here (not imported) to keep the edge bundle
// self-contained. Source of truth: src/index.css and src/config/brand.js.
// ===========================================================================
...
function chip(label, value, color) {
  return (
    ...
    >
      <span style={{ fontFamily: 'Fredoka', fontSize: 26, color: 'rgba(250,244,233,0.72)', letterSpacing: 1 }}>
        {label}
      </span>
      <span style={{ fontFamily: 'Cinzel', fontSize: 46, color }}>{value}</span>
    </div>
  );
}
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <span style={{ fontFamily: 'Cinzel', fontSize: 56, color: C.gold, letterSpacing: 2 }}>
                {BRAND.wordmark}
              </span>
              <span style={{ fontFamily: 'Fredoka', fontSize: 24, color: 'rgba(255,182,39,0.85)', letterSpacing: 6 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <span style={{ fontFamily: 'Fredoka', fontSize: 30, letterSpacing: 8, color: 'rgba(250,244,233,0.65)' }}>
                SCORE
              </span>
              <span style={{ fontFamily: 'Cinzel', fontSize: 200, lineHeight: 1, color: '#ffffff' }}>
                {score.toLocaleString()}
              </span>
              {combo != null && (
                <span style={{ fontFamily: 'Fredoka', fontSize: 30, color: C.fireBright, marginTop: 8 }}>
                  Best combo ×{combo}
                </span>
              )}
            </div>
